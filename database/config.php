...
<?php
    ...
    {
      execution_time("[START][EXECUTION_TIME] get_all_penggunaan");
    ...
    {
      execution_time("[START][EXECUTION_TIME] get_all_tagihan");
      $data_mode = "administrator";
      ...
      execution_time("[END][EXECUTION_TIME] get_all_tagihan");
      return $all_tagihan;
    }

    function get_all_pembayaran($db, $id_pelanggan = "")
    {
      execution_time("[START][EXECUTION_TIME] get_all_pembayaran");
      $data_mode = "administrator";
      ...
      execution_time("[END][EXECUTION_TIME] get_all_pembayaran");
      return $all_tagihan;
    }

    function get_all_tarif($db)
    {
      execution_time("[START][EXECUTION_TIME] get_all_tarif");
      ...
      execution_time("[END][EXECUTION_TIME] get_all_tarif");
      return $all_tarif;
    }
